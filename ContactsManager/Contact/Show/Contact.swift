...
//        self.registered = registered ?? FieldValue.serverTimestamp()
        self.tags = tags
    }
...
//        var xxx = ""
    ...
    func toString() -> String {
        return "id: \(id ?? "NO AUTOID"), firstname: \(firstname), lastname: \(lastname), email: \(email), phone: \(phone), photo: \(photo), favourite \(favourite), note: \(note)"
    }
